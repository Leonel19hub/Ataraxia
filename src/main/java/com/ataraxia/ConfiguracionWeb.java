...
import com.ataraxia.service.imp.LoginService;
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
			.authorizeRequests()
				...
				.antMatchers("/", "/index", "/registroUsuario", "/guardarUsuario", "/index/movie/{id}").permitAll()
				.antMatchers("/listadoUsuario", "/mostrarComprasTicket", "/nuevaPelicula", "/mostrarPeliculas").hasAuthority("ADMIN")
